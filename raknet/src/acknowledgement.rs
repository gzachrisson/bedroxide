...
mod tests {
    ...
    use super::{Acknowledgement, AcknowledgementRange, OutgoingAcknowledgements};
    ...
    fn outgoing_acks_pop_range_one_range_start_end_same() {
        ...
        //Assert
        assert_eq!(range, Some(AcknowledgementRange::new(1u8.into(), 1u8.into())));
    ...
    fn outgoing_acks_pop_range_one_range_start_end_different() {
        ...
        //Assert
        assert_eq!(range, Some(AcknowledgementRange::new(1u8.into(), 3u8.into())));
        assert_eq!(empty, None);
    }
    ...
    fn outgoing_acks_pop_range_multiple_ranges() {
        ...
        //Assert
        assert_eq!(range1, Some(AcknowledgementRange::new(1u8.into(), 1u8.into())));
        assert_eq!(range2, Some(AcknowledgementRange::new(5u8.into(), 7u8.into())));
        assert_eq!(range3, Some(AcknowledgementRange::new(10u8.into(), 11u8.into())));
        assert_eq!(range4, Some(AcknowledgementRange::new(20u8.into(), 20u8.into())));
        assert_eq!(empty, None);
    }
